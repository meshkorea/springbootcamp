...
public class HexagonalTest {
  ...
  static final JavaClasses importedClasses = new ClassFileImporter()
      ...
      .importPackages("com.vroong.order");

  @Test
  public void domainShouldNotDependOnAnyOtherPackages() {
    noClasses()
        .that()
        .resideInAnyPackage("com.vroong.order.domain..")
        .should()
        .dependOnClassesThat()
        .resideInAnyPackage("com.vroong.order.application..", "com.vroong.order.adapter..")
  ...
  public void applicationShouldNotDependOnAdapter() {
    noClasses()
        .that()
        .resideInAnyPackage("com.vroong.order.application..")
        .should()
        .dependOnClassesThat()
        .resideInAnyPackage("com.vroong.order.adapter..")
