package com.vroong.template.adapter.in.rest;

import com.vroong.template.adapter.in.rest.error.BadRequestAlertException;
import com.vroong.template.adapter.in.rest.mapper.ExampleMapper;
import com.vroong.template.application.ExampleService;
import com.vroong.template.domain.Example;
import com.vroong.template.rest.ExampleApiDelegate;
import com.vroong.template.rest.ExampleDto;
import com.vroong.template.rest.ExampleListDto;
import com.vroong.template.rest.PageDto;
...
import static com.vroong.template.adapter.in.rest.error.ErrorConstants.CONSTRAINT_VIOLATION_TYPE;
...
public class ExampleApiDelegateImpl implements ExampleApiDelegate {
   ...
   * {
   *   "type": "template/problem-with-message",
   *   "title": "Unauthorized",
   *   "status": 401,
   ...
   * {
   *   "errorKey": "template/constraint-violation",
