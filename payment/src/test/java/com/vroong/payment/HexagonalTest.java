...
public class HexagonalTest {
  ...
  static final JavaClasses importedClasses = new ClassFileImporter()
      ...
      .importPackages("com.vroong.payment");

  @Test
  public void domainShouldNotDependOnAnyOtherPackages() {
    noClasses()
        .that()
        .resideInAnyPackage("com.vroong.payment.domain..")
        .should()
        .dependOnClassesThat()
        .resideInAnyPackage("com.vroong.payment.application..", "com.vroong.payment.adapter..")
  ...
  public void applicationShouldNotDependOnAdapter() {
    noClasses()
        .that()
        .resideInAnyPackage("com.vroong.payment.application..")
        .should()
        .dependOnClassesThat()
        .resideInAnyPackage("com.vroong.payment.adapter..")
